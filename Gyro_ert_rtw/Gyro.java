...
public class Gyro extends AppCompatActivity implements OnFragmentInteractionListener , SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.example.Gyro.databinding.ActivityMainBinding activityMainBinding = ActivityMainBinding.inflate(LayoutInflater.from(this));
    ...
    private Gyro thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","Gyro"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("Gyro.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
    private native int naMain(String[] argv, Gyro pThis);
    private native void naOnAppStateChange(int state);
    static {
        System.loadLibrary("Gyro");
    }
