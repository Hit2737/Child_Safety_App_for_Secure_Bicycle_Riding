...
static void cgxe_mdl_start(InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_tCAoFCyNXuiliD9y4OuwTB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_tCAoFCyNXuiliD9y4OuwTB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_tCAoFCyNXuiliD9y4OuwTB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_tCAoFCyNXuiliD9y4OuwTB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_tCAoFCyNXuiliD9y4OuwTB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_tCAoFCyNXuiliD9y4OuwTB
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_tCAoFCyNXuiliD9y4OuwTB
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_tCAoFCyNXuiliD9y4OuwTB
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_tCAoFCyNXuiliD9y4OuwTB
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_tCAoFCyNXuiliD9y4OuwTB
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_tCAoFCyNXuiliD9y4OuwTB
...
static void cgxe_mdl_set_sim_state(InstanceStruct_tCAoFCyNXuiliD9y4OuwTB
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_tCAoFCyNXuiliD9y4OuwTB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_tCAoFCyNXuiliD9y4OuwTB(SimStruct *S, int_T tid)
{
  InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *moduleInstance =
    (InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_tCAoFCyNXuiliD9y4OuwTB(SimStruct *S)
{
  InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *moduleInstance =
    (InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_tCAoFCyNXuiliD9y4OuwTB(SimStruct *S, int_T tid)
{
  InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *moduleInstance =
    (InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_tCAoFCyNXuiliD9y4OuwTB(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *moduleInstance =
    (InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *)cgxertGetRuntimeInstance(S);
...
static void setSimState_tCAoFCyNXuiliD9y4OuwTB(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *moduleInstance =
    (InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_tCAoFCyNXuiliD9y4OuwTB(SimStruct *S)
{
  InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *moduleInstance =
    (InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_tCAoFCyNXuiliD9y4OuwTB(SimStruct *S)
{
  InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *moduleInstance =
    (InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_tCAoFCyNXuiliD9y4OuwTB(SimStruct *S)
{
  InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *moduleInstance =
    (InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_tCAoFCyNXuiliD9y4OuwTB(SimStruct *S)
{
  InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *moduleInstance =
    (InstanceStruct_tCAoFCyNXuiliD9y4OuwTB *)calloc(1, sizeof
    (InstanceStruct_tCAoFCyNXuiliD9y4OuwTB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_tCAoFCyNXuiliD9y4OuwTB);
  ssSetmdlInitializeConditions(S, mdlInitialize_tCAoFCyNXuiliD9y4OuwTB);
  ssSetmdlUpdate(S, mdlUpdate_tCAoFCyNXuiliD9y4OuwTB);
  ssSetmdlTerminate(S, mdlTerminate_tCAoFCyNXuiliD9y4OuwTB);
  ssSetmdlEnable(S, mdlEnable_tCAoFCyNXuiliD9y4OuwTB);
  ssSetmdlDisable(S, mdlDisable_tCAoFCyNXuiliD9y4OuwTB);
...
static void mdlProcessParameters_tCAoFCyNXuiliD9y4OuwTB(SimStruct *S)
{
}

void method_dispatcher_tCAoFCyNXuiliD9y4OuwTB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_tCAoFCyNXuiliD9y4OuwTB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_tCAoFCyNXuiliD9y4OuwTB(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_tCAoFCyNXuiliD9y4OuwTB(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_tCAoFCyNXuiliD9y4OuwTB(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: tCAoFCyNXuiliD9y4OuwTB.\n"
...
mxArray *cgxe_tCAoFCyNXuiliD9y4OuwTB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_tCAoFCyNXuiliD9y4OuwTB_fallback_info(void)
{
