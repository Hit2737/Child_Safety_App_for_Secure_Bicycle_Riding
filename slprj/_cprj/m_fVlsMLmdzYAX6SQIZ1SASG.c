...
static void cgxe_mdl_start(InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG
...
static void cgxe_mdl_set_sim_state(InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_fVlsMLmdzYAX6SQIZ1SASG(SimStruct *S, int_T tid)
{
  InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *moduleInstance =
    (InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_fVlsMLmdzYAX6SQIZ1SASG(SimStruct *S)
{
  InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *moduleInstance =
    (InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_fVlsMLmdzYAX6SQIZ1SASG(SimStruct *S, int_T tid)
{
  InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *moduleInstance =
    (InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_fVlsMLmdzYAX6SQIZ1SASG(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *moduleInstance =
    (InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *)cgxertGetRuntimeInstance(S);
...
static void setSimState_fVlsMLmdzYAX6SQIZ1SASG(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *moduleInstance =
    (InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_fVlsMLmdzYAX6SQIZ1SASG(SimStruct *S)
{
  InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *moduleInstance =
    (InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_fVlsMLmdzYAX6SQIZ1SASG(SimStruct *S)
{
  InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *moduleInstance =
    (InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_fVlsMLmdzYAX6SQIZ1SASG(SimStruct *S)
{
  InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *moduleInstance =
    (InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_fVlsMLmdzYAX6SQIZ1SASG(SimStruct *S)
{
  InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *moduleInstance =
    (InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG *)calloc(1, sizeof
    (InstanceStruct_fVlsMLmdzYAX6SQIZ1SASG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_fVlsMLmdzYAX6SQIZ1SASG);
  ssSetmdlInitializeConditions(S, mdlInitialize_fVlsMLmdzYAX6SQIZ1SASG);
  ssSetmdlUpdate(S, mdlUpdate_fVlsMLmdzYAX6SQIZ1SASG);
  ssSetmdlTerminate(S, mdlTerminate_fVlsMLmdzYAX6SQIZ1SASG);
  ssSetmdlEnable(S, mdlEnable_fVlsMLmdzYAX6SQIZ1SASG);
  ssSetmdlDisable(S, mdlDisable_fVlsMLmdzYAX6SQIZ1SASG);
...
static void mdlProcessParameters_fVlsMLmdzYAX6SQIZ1SASG(SimStruct *S)
{
}

void method_dispatcher_fVlsMLmdzYAX6SQIZ1SASG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_fVlsMLmdzYAX6SQIZ1SASG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_fVlsMLmdzYAX6SQIZ1SASG(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_fVlsMLmdzYAX6SQIZ1SASG(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_fVlsMLmdzYAX6SQIZ1SASG(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: fVlsMLmdzYAX6SQIZ1SASG.\n"
...
mxArray *cgxe_fVlsMLmdzYAX6SQIZ1SASG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_fVlsMLmdzYAX6SQIZ1SASG_fallback_info(void)
{
