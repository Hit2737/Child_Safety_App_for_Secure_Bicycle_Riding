...
static void cgxe_mdl_start(InstanceStruct_r6d06wCYakWyxELBslgYXE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_r6d06wCYakWyxELBslgYXE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_r6d06wCYakWyxELBslgYXE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_r6d06wCYakWyxELBslgYXE
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_r6d06wCYakWyxELBslgYXE
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_r6d06wCYakWyxELBslgYXE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_r6d06wCYakWyxELBslgYXE
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_r6d06wCYakWyxELBslgYXE
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_r6d06wCYakWyxELBslgYXE
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_r6d06wCYakWyxELBslgYXE
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_r6d06wCYakWyxELBslgYXE
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_r6d06wCYakWyxELBslgYXE *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_r6d06wCYakWyxELBslgYXE
...
static void cgxe_mdl_set_sim_state(InstanceStruct_r6d06wCYakWyxELBslgYXE
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_r6d06wCYakWyxELBslgYXE
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_r6d06wCYakWyxELBslgYXE(SimStruct *S, int_T tid)
{
  InstanceStruct_r6d06wCYakWyxELBslgYXE *moduleInstance =
    (InstanceStruct_r6d06wCYakWyxELBslgYXE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_r6d06wCYakWyxELBslgYXE(SimStruct *S)
{
  InstanceStruct_r6d06wCYakWyxELBslgYXE *moduleInstance =
    (InstanceStruct_r6d06wCYakWyxELBslgYXE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_r6d06wCYakWyxELBslgYXE(SimStruct *S, int_T tid)
{
  InstanceStruct_r6d06wCYakWyxELBslgYXE *moduleInstance =
    (InstanceStruct_r6d06wCYakWyxELBslgYXE *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_r6d06wCYakWyxELBslgYXE(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_r6d06wCYakWyxELBslgYXE *moduleInstance =
    (InstanceStruct_r6d06wCYakWyxELBslgYXE *)cgxertGetRuntimeInstance(S);
...
static void setSimState_r6d06wCYakWyxELBslgYXE(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_r6d06wCYakWyxELBslgYXE *moduleInstance =
    (InstanceStruct_r6d06wCYakWyxELBslgYXE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_r6d06wCYakWyxELBslgYXE(SimStruct *S)
{
  InstanceStruct_r6d06wCYakWyxELBslgYXE *moduleInstance =
    (InstanceStruct_r6d06wCYakWyxELBslgYXE *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_r6d06wCYakWyxELBslgYXE(SimStruct *S)
{
  InstanceStruct_r6d06wCYakWyxELBslgYXE *moduleInstance =
    (InstanceStruct_r6d06wCYakWyxELBslgYXE *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_r6d06wCYakWyxELBslgYXE(SimStruct *S)
{
  InstanceStruct_r6d06wCYakWyxELBslgYXE *moduleInstance =
    (InstanceStruct_r6d06wCYakWyxELBslgYXE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_r6d06wCYakWyxELBslgYXE(SimStruct *S)
{
  InstanceStruct_r6d06wCYakWyxELBslgYXE *moduleInstance =
    (InstanceStruct_r6d06wCYakWyxELBslgYXE *)calloc(1, sizeof
    (InstanceStruct_r6d06wCYakWyxELBslgYXE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_r6d06wCYakWyxELBslgYXE);
  ssSetmdlInitializeConditions(S, mdlInitialize_r6d06wCYakWyxELBslgYXE);
  ssSetmdlUpdate(S, mdlUpdate_r6d06wCYakWyxELBslgYXE);
  ssSetmdlTerminate(S, mdlTerminate_r6d06wCYakWyxELBslgYXE);
  ssSetmdlEnable(S, mdlEnable_r6d06wCYakWyxELBslgYXE);
  ssSetmdlDisable(S, mdlDisable_r6d06wCYakWyxELBslgYXE);
...
static void mdlProcessParameters_r6d06wCYakWyxELBslgYXE(SimStruct *S)
{
}

void method_dispatcher_r6d06wCYakWyxELBslgYXE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_r6d06wCYakWyxELBslgYXE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_r6d06wCYakWyxELBslgYXE(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_r6d06wCYakWyxELBslgYXE(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_r6d06wCYakWyxELBslgYXE(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: r6d06wCYakWyxELBslgYXE.\n"
...
mxArray *cgxe_r6d06wCYakWyxELBslgYXE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_r6d06wCYakWyxELBslgYXE_fallback_info(void)
{
