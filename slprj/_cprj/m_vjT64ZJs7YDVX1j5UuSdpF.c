...
#include "m_vjT64ZJs7YDVX1j5UuSdpF.h"
...
static void cgxe_mdl_start(InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF
...
static void cgxe_mdl_set_sim_state(InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_vjT64ZJs7YDVX1j5UuSdpF(SimStruct *S, int_T tid)
{
  InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *moduleInstance =
    (InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_vjT64ZJs7YDVX1j5UuSdpF(SimStruct *S)
{
  InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *moduleInstance =
    (InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_vjT64ZJs7YDVX1j5UuSdpF(SimStruct *S, int_T tid)
{
  InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *moduleInstance =
    (InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_vjT64ZJs7YDVX1j5UuSdpF(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *moduleInstance =
    (InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *)cgxertGetRuntimeInstance(S);
...
static void setSimState_vjT64ZJs7YDVX1j5UuSdpF(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *moduleInstance =
    (InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_vjT64ZJs7YDVX1j5UuSdpF(SimStruct *S)
{
  InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *moduleInstance =
    (InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_vjT64ZJs7YDVX1j5UuSdpF(SimStruct *S)
{
  InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *moduleInstance =
    (InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_vjT64ZJs7YDVX1j5UuSdpF(SimStruct *S)
{
  InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *moduleInstance =
    (InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_vjT64ZJs7YDVX1j5UuSdpF(SimStruct *S)
{
  InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *moduleInstance =
    (InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF *)calloc(1, sizeof
    (InstanceStruct_vjT64ZJs7YDVX1j5UuSdpF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_vjT64ZJs7YDVX1j5UuSdpF);
  ssSetmdlInitializeConditions(S, mdlInitialize_vjT64ZJs7YDVX1j5UuSdpF);
  ssSetmdlUpdate(S, mdlUpdate_vjT64ZJs7YDVX1j5UuSdpF);
  ssSetmdlTerminate(S, mdlTerminate_vjT64ZJs7YDVX1j5UuSdpF);
  ssSetmdlEnable(S, mdlEnable_vjT64ZJs7YDVX1j5UuSdpF);
  ssSetmdlDisable(S, mdlDisable_vjT64ZJs7YDVX1j5UuSdpF);
...
static void mdlProcessParameters_vjT64ZJs7YDVX1j5UuSdpF(SimStruct *S)
{
}

void method_dispatcher_vjT64ZJs7YDVX1j5UuSdpF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_vjT64ZJs7YDVX1j5UuSdpF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_vjT64ZJs7YDVX1j5UuSdpF(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_vjT64ZJs7YDVX1j5UuSdpF(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_vjT64ZJs7YDVX1j5UuSdpF(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: vjT64ZJs7YDVX1j5UuSdpF.\n"
...
mxArray *cgxe_vjT64ZJs7YDVX1j5UuSdpF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_vjT64ZJs7YDVX1j5UuSdpF_fallback_info(void)
{
