...
#include "m_ABPZ6B7ZuGhTZqW7SrKXlC.h"
...
static void cgxe_mdl_start(InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_ABPZ6B7ZuGhTZqW7SrKXlC(SimStruct *S, int_T tid)
{
  InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *moduleInstance =
    (InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_ABPZ6B7ZuGhTZqW7SrKXlC(SimStruct *S)
{
  InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *moduleInstance =
    (InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_ABPZ6B7ZuGhTZqW7SrKXlC(SimStruct *S, int_T tid)
{
  InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *moduleInstance =
    (InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_ABPZ6B7ZuGhTZqW7SrKXlC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *moduleInstance =
    (InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_ABPZ6B7ZuGhTZqW7SrKXlC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *moduleInstance =
    (InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_ABPZ6B7ZuGhTZqW7SrKXlC(SimStruct *S)
{
  InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *moduleInstance =
    (InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_ABPZ6B7ZuGhTZqW7SrKXlC(SimStruct *S)
{
  InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *moduleInstance =
    (InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_ABPZ6B7ZuGhTZqW7SrKXlC(SimStruct *S)
{
  InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *moduleInstance =
    (InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_ABPZ6B7ZuGhTZqW7SrKXlC(SimStruct *S)
{
  InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *moduleInstance =
    (InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC *)calloc(1, sizeof
    (InstanceStruct_ABPZ6B7ZuGhTZqW7SrKXlC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_ABPZ6B7ZuGhTZqW7SrKXlC);
  ssSetmdlInitializeConditions(S, mdlInitialize_ABPZ6B7ZuGhTZqW7SrKXlC);
  ssSetmdlUpdate(S, mdlUpdate_ABPZ6B7ZuGhTZqW7SrKXlC);
  ssSetmdlTerminate(S, mdlTerminate_ABPZ6B7ZuGhTZqW7SrKXlC);
  ssSetmdlEnable(S, mdlEnable_ABPZ6B7ZuGhTZqW7SrKXlC);
  ssSetmdlDisable(S, mdlDisable_ABPZ6B7ZuGhTZqW7SrKXlC);
...
static void mdlProcessParameters_ABPZ6B7ZuGhTZqW7SrKXlC(SimStruct *S)
{
}

void method_dispatcher_ABPZ6B7ZuGhTZqW7SrKXlC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_ABPZ6B7ZuGhTZqW7SrKXlC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_ABPZ6B7ZuGhTZqW7SrKXlC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_ABPZ6B7ZuGhTZqW7SrKXlC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_ABPZ6B7ZuGhTZqW7SrKXlC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: ABPZ6B7ZuGhTZqW7SrKXlC.\n"
...
mxArray *cgxe_ABPZ6B7ZuGhTZqW7SrKXlC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_ABPZ6B7ZuGhTZqW7SrKXlC_fallback_info(void)
{
