...
static void cgxe_mdl_start(InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_blSUn4QnJNLfWyYmFDGX2
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_blSUn4QnJNLfWyYmFDGX2
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_blSUn4QnJNLfWyYmFDGX2
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_blSUn4QnJNLfWyYmFDGX2
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_blSUn4QnJNLfWyYmFDGX2
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_blSUn4QnJNLfWyYmFDGX2
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_blSUn4QnJNLfWyYmFDGX2
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_blSUn4QnJNLfWyYmFDGX2
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_blSUn4QnJNLfWyYmFDGX2
...
static void cgxe_mdl_set_sim_state(InstanceStruct_blSUn4QnJNLfWyYmFDGX2
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_blSUn4QnJNLfWyYmFDGX2
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_blSUn4QnJNLfWyYmFDGX2(SimStruct *S, int_T tid)
{
  InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *moduleInstance =
    (InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_blSUn4QnJNLfWyYmFDGX2(SimStruct *S)
{
  InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *moduleInstance =
    (InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_blSUn4QnJNLfWyYmFDGX2(SimStruct *S, int_T tid)
{
  InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *moduleInstance =
    (InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_blSUn4QnJNLfWyYmFDGX2(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *moduleInstance =
    (InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *)cgxertGetRuntimeInstance(S);
...
static void setSimState_blSUn4QnJNLfWyYmFDGX2(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *moduleInstance =
    (InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_blSUn4QnJNLfWyYmFDGX2(SimStruct *S)
{
  InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *moduleInstance =
    (InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_blSUn4QnJNLfWyYmFDGX2(SimStruct *S)
{
  InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *moduleInstance =
    (InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_blSUn4QnJNLfWyYmFDGX2(SimStruct *S)
{
  InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *moduleInstance =
    (InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_blSUn4QnJNLfWyYmFDGX2(SimStruct *S)
{
  InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *moduleInstance =
    (InstanceStruct_blSUn4QnJNLfWyYmFDGX2 *)calloc(1, sizeof
    (InstanceStruct_blSUn4QnJNLfWyYmFDGX2));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_blSUn4QnJNLfWyYmFDGX2);
  ssSetmdlInitializeConditions(S, mdlInitialize_blSUn4QnJNLfWyYmFDGX2);
  ssSetmdlUpdate(S, mdlUpdate_blSUn4QnJNLfWyYmFDGX2);
  ssSetmdlTerminate(S, mdlTerminate_blSUn4QnJNLfWyYmFDGX2);
  ssSetmdlEnable(S, mdlEnable_blSUn4QnJNLfWyYmFDGX2);
  ssSetmdlDisable(S, mdlDisable_blSUn4QnJNLfWyYmFDGX2);
...
static void mdlProcessParameters_blSUn4QnJNLfWyYmFDGX2(SimStruct *S)
{
}

void method_dispatcher_blSUn4QnJNLfWyYmFDGX2(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_blSUn4QnJNLfWyYmFDGX2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_blSUn4QnJNLfWyYmFDGX2(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_blSUn4QnJNLfWyYmFDGX2(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_blSUn4QnJNLfWyYmFDGX2(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: blSUn4QnJNLfWyYmFDGX2.\n"
...
mxArray *cgxe_blSUn4QnJNLfWyYmFDGX2_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_blSUn4QnJNLfWyYmFDGX2_fallback_info(void)
{
