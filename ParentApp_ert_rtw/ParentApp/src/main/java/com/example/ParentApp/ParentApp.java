...
public class ParentApp extends AppCompatActivity implements OnFragmentInteractionListener , CvCameraViewListener2 {
 ...
 // properties specific for Camera block
   ...
   private boolean isCamera2Supported() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.example.ParentApp.databinding.ActivityMainBinding activityMainBinding = ActivityMainBinding.inflate(LayoutInflater.from(this));
...
mReceiveBlockNames = getResources().getStringArray(R.array.tcpReceiveBlockNames);
    ...
    private ParentApp thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","ParentApp"};
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("ParentApp.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
...
public void audioFileReadTerminate(int idx) {
    ...
    private native int naMain(String[] argv, ParentApp pThis);
